...
public class BoardTest {
    ...
    @Test
    void validBoardDimensionsPassAtBoundaries() {
        String input = "board(1,1);";
        BoardGameLangParser parser = ParseTreeHelper.createParser(input);
        ProgramNode program = (ProgramNode) new AstBuilder().visit(parser.program());
    ...
    @Test
    void zeroBoardWidthFails() {
        String input = "board(0,3);";
        BoardGameLangParser parser = ParseTreeHelper.createParser(input);
        ProgramNode program = (ProgramNode) new AstBuilder().visit(parser.program());
    ...
    @Test
    void zeroBoardHeightFails() {
        String input = "board(3,0);";
        BoardGameLangParser parser = ParseTreeHelper.createParser(input);
        ProgramNode program = (ProgramNode) new AstBuilder().visit(parser.program());
